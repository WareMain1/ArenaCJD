...
try {
    ...
    echo '[' . date('Y-m-d H:i:s') . '] Estados sincronizados: ' . $actualizados . ' torneos. Enfrentamientos resueltos: ' . $reporte['resueltos_automaticamente'] . ', revisión: ' . $reporte['enviados_a_revision'] . PHP_EOL;
    exit(0);
